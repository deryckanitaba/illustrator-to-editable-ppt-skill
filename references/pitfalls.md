...
- Do not make a full-page screenshot and blur or repair the text area. Export non-text graphics as transparent PNG layers.
...
- Complex fonts, special effects, and individual line wrapping still need manual inspection.
...
- Run `verify_pptx.py` after building the PPTX.
